...
execute as @a run execute as @s store result score @s rad_x run random value -100..100
execute as @a run execute as @s store result score @s rad_y run random value -100..100
execute as @a run execute as @s store result score @s rad_z run random value -100..100
#你当然可以自己改数值
